...
exports.seed = async function (knex) {
  ...
  // -----------------------------------------------------------------
  // v2_ciclo_escala (18 linhas)
  // CORRIGIDO em 04/08/2026 com base na "ESCALA DESPACHANTE COPOM" real:
  // dia1 A-F-E, dia2 B-A-F, dia3 C-B-A, dia4 D-C-B, dia5 E-D-C, dia6 F-E-D
  // Fórmula geral: no dia_ciclo N, o 1º turno é o grupamento N (A=1..F=6),
  // o 2º turno é o grupamento N-1, o 3º turno é o grupamento N-2 (com
  // "volta ao início" quando o índice fica menor que 1).
  // -----------------------------------------------------------------
  ...
  // CORRIGIDO: 01/07/2026 é o dia 1 do ciclo (grupamento A no 1º turno),
  // conforme confirmado pelo Scrum Master e pela escala real.
  // -----------------------------------------------------------------
